...
async function consultaPlacas() {
    ...
    for (let placa of placas){
        txtPlacas = txtPlacas.concat('<tr><td style="width: 600px ; border: 1px solid black;">' + placa.desc.toString() + '</td><td style="width: 100px ; border: 1px solid black;">' + placa.precio.toString() + '</td><td style="width: 200px ; border: 1px solid black;">' + placa.vendedor.toString() + '</td></tr>');
    };
...
exports.consultaPlacas = consultaPlacas;